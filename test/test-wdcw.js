...
describe('webtrends-infinity-web-data-connector-connector:setup', function describesConnectorSetup() {
  var setUpComplete;
...
describe('webtrends-infinity-web-data-connector-connector:columnHeaders', function describesConnectorColumnHeaders() {
  var registerHeaders;
...
describe('webtrends-infinity-web-data-connector-connector:tableData', function describesConnectorTableData() {
  var registerData;
...
describe('webtrends-infinity-web-data-connector-connector:teardown', function describesConnectorTearDown() {
